const resumeData={
    "basics": {
      ...
      "location": {
        ...
        "postalCode": "Your postal code (ZIP in the Tamil Nadu)",
        "city": "Your city",
        "countryCode": "Your country (e.g. India)",
        "region": "Your region (state in the India)"
      },
      "profiles": [
        {
    ...
    "skills": [
      {
        ...
        "level": "",
        "keywords": [
          "Keywords under this category (e.g. 'Javascript', 'Python', etc)"
        ]
      }
    ],
    "languages": [
